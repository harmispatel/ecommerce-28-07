...
const ManageCategories = () => {
    ...
    const handleEditCategory = (item) => {
        ...
        setLoading(true);
        setCurrentItem(item);
        setFormData({ categoryName: item?.categoryName, status: item?.status });
    ...
    const handleUpdateCategory = () => {
        const updatedData = categoryData.map(item =>
            item.id === currentItem.id ? { ...item, categoryName: formData?.categoryName, status: formData.status } : item
        );
    ...
    const tableItems = categoryData.map((item, index) => {
        let statusView;
